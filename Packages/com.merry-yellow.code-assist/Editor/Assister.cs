...
namespace Meryel.UnityCodeAssist.Editor
{
    ...
    {
        public const string Version = "1.4.12"; //do NOT modify this line, except the number value, its being used by VSCode/Typescript for version detection (in exporter.ts.getVersionOfUnitySide())
